...
export const HIRE_GUIDES = [
  ...
  },
  {
    ...
    extra: [
      ...
      "Download or print the FY statement when a coordinator or plan manager wants a running total for 1 July to 30 June, without unpaid or cancelled weeks. Invoice numbers on that summary match each tax invoice PDF.",
    ],
  },
] as const;
