...
export const featuredCarers: FeaturedCarer[] = [
  ...
  },
  {
    ...
    bio: "Parents book me when the restaurant booking is already made. I arrive with a small bag of books and quiet games, follow the bedtime you write down, and text once the house is settled. Cert III in Early Childhood Education. No extra charge for siblings.",
    hourlyRateCents: 4200,
    yearsExperience: 6,
    suburb: "Newtown",
    state: "nsw",
    ...
    work: [
      {
        employer: "Inner west families, Newtown and Erskineville",
        title: "Casual babysitter",
        start: "2021-04-01",
        duties: "Date nights, last-minute cancellations and sibling groups of two to four.",
        verification: "document",
        hours: 2100,
      },
    ],
  ...
  },
  {
    ...
    bio: "I cover the hours after daycare — dinner, bath, stories — so you can go out. Holiday visitors book me for a run of evenings in the same week. First aid includes asthma and anaphylaxis. I tidy the play room before I leave.",
    hourlyRateCents: 4000,
    yearsExperience: 5,
    suburb: "Fitzroy",
    state: "vic",
    ...
    work: [
      {
        employer: "Private families, Fitzroy and Collingwood",
        title: "Evening sitter",
        start: "2022-01-10",
        duties: "Dinner, bedtime and tidy-up for toddlers through early primary.",
        verification: "employer_confirmed",
        hours: 1600,
      },
    ],
  ...
  },
  {
    ...
    bio: "English and Mandarin. I look after children staying in hotels or with relatives for the Gabba, the Ekka or a long weekend. Overnight sits are a normal part of the week for me, not a special request. Child first aid current.",
    hourlyRateCents: 4600,
    yearsExperience: 8,
    suburb: "West End",
    state: "qld",
    ...
    work: [
      {
        employer: "Visiting families, South Bank hotels",
        title: "Overnight nanny",
        start: "2020-08-01",
        duties: "Hotel and apartment overnight care, sibling groups, early breakfasts.",
        verification: "document",
        hours: 3200,
      },
    ],
  ...
  },
  {
    ...
    bio: "Two or four children is the same hourly rate. I am used to sandy feet, late dinners and a 10pm return. WWCC and first aid with anaphylaxis. Instant Book for Friday and Saturday evenings.",
    hourlyRateCents: 3900,
    yearsExperience: 4,
    suburb: "Cottesloe",
    state: "wa",
    ...
    credentials: [
      ...
      { type: "first_aid", months: 6 },
    ],
    work: [
      {
        employer: "Western suburbs families",
        title: "Babysitter",
        start: "2023-01-15",
        duties: "Weekend evenings and holiday days for regular households.",
        verification: "document",
        hours: 980,
      },
    ],
  ...
  },
  {
    ...
    bio: "I keep a car seat in the boot and can take a last-minute job if you write before 4pm. After-school pick-up, date nights and the odd wedding. WWCC and child first aid. Message me the address and allergies — I do not charge extra for a second child.",
    hourlyRateCents: 4400,
    yearsExperience: 7,
    suburb: "Redfern",
    state: "nsw",
    ...
    work: [
      {
        employer: "Event and last-minute sits, inner Sydney",
        title: "Babysitter",
        start: "2019-11-01",
        duties: "Same-day evenings, wedding childcare and school pick-up with own car.",
        verification: "employer_confirmed",
        hours: 2800,
      },
    ],
  ...
  },
  {
    ...
    bio: "Weddings, conferences and the night you stay out. I keep a written handover and a morning note so you know how sleep went. Blue Card and first aid including asthma. Recurring Friday nights welcome.",
    hourlyRateCents: 4300,
    yearsExperience: 6,
    ...
    work: [
      {
        employer: "Private family, New Farm",
        title: "Friday-night sitter",
        start: "2021-09-01",
        duties: "Standing Friday evenings plus occasional overnight wedding cover.",
        verification: "document",
        hours: 1900,
      },
    ],
